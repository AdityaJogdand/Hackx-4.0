      ...
      {ranks.map((rank, index) => (
        ...
        >
          ...
          <div className="flex justify-between items-start">
            <span
              className={`text-6xl md:text-8xl font-black italic opacity-10 transition-colors duration-500 ${rank.accent} group-hover:text-white group-hover:opacity-20`}
            >
              {rank.id}
            </span>
          ...
          {/* Bottom Section: Prize Worth */}
          <div className="flex flex-col items-start">
            <span
              className={`text-5xl md:text-7xl font-black transition-colors duration-500 ${
                rank.id === "01"
